            ...
            if reset_n_i = '1' then
                ...
                case state is
                     ...
                     when S_LATCH =>
                        ...
                        shift_reg <= tx_data_i; -- latch tx_data_i to shift register
                        bit_count <= 0;
                    ...
                    when S_SHIFT =>
                     ...
                     when S_FINISH =>
                        ...
                        rx_data_o <= shift_reg; -- 8 bits pulled from shift register are now put to the rx_data_o output port so user logic can read it
